...
const site = {
  ...
  "repo": "pipeline",
  "stage": "Beta",
  "description": "Local-first TypeScript pipeline engine for typed task graphs, run evidence, cache inputs, and generated GitHub Actions workflows.",
  "lead": "Run the same verification workflow on a laptop and in CI while keeping workflow logic inspectable in pipeline.ts.",
  "quickstart": "pnpm add -D @async/pipeline\npnpm run pipeline:verify",
  "docsRoots": [
    "docs"
  ]
};
