---
title: "Sync: Choose What GitHub And npm See"
description: "pipeline.ts is the single source of truth. Sync is the explicit, checked boundary that decides what GitHub Actions and package.json receive."
---
