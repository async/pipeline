...
| `@async/pipeline.declaration` | `sha256:2df6a665cf29c8387ce9be3e22e08dc943ca21044ae139daf0995ae5addf2524` | `agent.stdoutTo`, `agent.step`, `config.definePipeline`, `config.env`, `config.github.pages`, `config.job`, `config.source`, `config.sync.github`, `config.sync.github.bridge`, `config.sync.github.pages`, `config.sync.tasks`, `config.task`, `config.trigger.github`, `config.trigger.manual`, `step.shell` |
